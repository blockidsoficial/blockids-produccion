...
const AutoScanningStep = props => {
    // Ofrece actualizar durante la exploración y después de una exploración fallida, siempre que haya una función de actualización.
    // Es posible que el escaneo encuentre "algún" dispositivo pero no el dispositivo deseado,
    // por lo que no limite la oferta de actualización solo al caso PHASES.notfound.
