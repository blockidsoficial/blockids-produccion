        ...
        <Box className={styles.bottomArea}>
            <Box className={classNames(styles.bottomAreaItem, styles.instructions)}>
                {(props.scanning || props.peripheralList.length > 0) && (
                    // Muestra este mensaje si aún estamos explorando O si hemos encontrado dispositivos
                    <FormattedMessage
                ...
                {showUpdate && (
                    // Muestra este mensaje si terminó el escaneo Y podemos actualizar
                    // Tenga en cuenta que es posible que la lista incluya dispositivos pero no incluya el dispositivo deseado,
                    // por lo que no limite este mensaje al caso (props.peripheralList.length === 0)
