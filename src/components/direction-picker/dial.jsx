...
class Dial extends React.Component {
    ...
    componentDidMount () {
        // Añade manualmente controladores de toque/mouse para que se pueda usar preventDefault
        // para evitar el desplazamiento en el toque.
        // Rastreado como un problema de reacción https://github.com/facebook/react/issues/6436
    ...
    handleMouseDown (e) {
        // Dado que el identificador de arrastre no es un punto único, hay alguna diferencia inicial
        // entre la dirección actual del sprite y la dirección hacia el mouse
        // Almacena este desplazamiento para evitar saltos cuando se mueve el mouse.
