...
const messages = defineMessages({
    ...
    // Las cadenas aquí deben definirse estáticamente
...
class LibraryComponent extends React.Component {
    ...
    componentDidMount () {
        // Permite que el spinner se muestre antes de cargar el contenido
        setTimeout(() => {
    ...
    handleMouseEnter (id) {
        // no reinicies si el mouse está sobre un elemento ya reproduciéndose
    ...
    getFilteredData () {
        if (this.state.selectedTag === ALL_TAG.tag) {
            ...
            return this.props.data.filter(dataItem => (
                (dataItem.tags || [])
                    // El segundo argumento de map establece `this`
                    .map(String.prototype.toLowerCase.call, String.prototype.toLowerCase)
                    .concat(dataItem.name ?
                        (typeof dataItem.name === 'string' ?
                        // Usa el nombre si es una cadena, en caso contrario usa formatMessage para obtener el nombre traducido
...
LibraryComponent.propTypes = {
    data: PropTypes.arrayOf(
        ...
        // Un elemento en la librería
        PropTypes.shape({
            // TODO: elimina la prop md5/rawURL de la librería, refactoriza para usar almacenamiento
