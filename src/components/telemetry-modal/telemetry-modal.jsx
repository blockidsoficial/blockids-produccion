...
// Esto debe ser al menos tan largo como la transición CSS
...
class TelemetryModal extends React.PureComponent {
    constructor (props) {
        ...
        this.state = {
            // si se muestra el mensaje settingWasUpdated, este será el ID de su temporizador de eliminación
    ...
    handleSettingWasUpdatedTimeout (thisTimer) {
        if (thisTimer !== this.state.settingWasUpdatedTimer) {
            // algún otro temporizador se ha hecho cargo
            return;
        }
        this.setState({
            settingWasUpdatedTimer: null
