...
class UsuarioActual extends React.Component {
    constructor (props) {
        super(props);
    ...
    componentDidMount () {
        supabase.auth.getSession().then(({data: {session}}) => {
            if (session && session.user) {
                ...
                this.setState({username: meta.username || session.user.email.replace('@blockids.com', '')});
            }
        });
    ...
    render () {
        ...
        return (
            ...
            >
                <div
                    className={classNames(styles.userBtn, styles.hoverable, {
                        [styles.active]: open
                    })}
        ...
        return (
            ...
            >
                ...
                <div className={styles.accountInfoGroup}>
                    ...
                    <button
                        className={styles.misProyectosLink}
                        onClick={() => { window.location.href = '/?vista=proyectos'; }}
                    >
                        {'Mis Proyectos'}
                    </button>
                    <UsuarioActual />
