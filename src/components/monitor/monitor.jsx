...
// Asignar el nombre de la categoría al nombre del color utilizado en scratch-blocks Blockly.Colours
...
const MonitorComponent = props => (
    ...
    >
        ...
        {ReactDOM.createPortal((
            // Usa un portal para renderizar el menú contextual fuera del flujo para evitar
            // conflictos de posicionamiento entre la escala de transformación de los monitores y
            // los menús contextuales de posición: fija. Para más detalles, ver
