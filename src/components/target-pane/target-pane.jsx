...
const spriteShape = PropTypes.shape({
    costume: PropTypes.shape({
        // el activo se define en Asset.js del almacenamiento de rasguños
        asset: PropTypes.object, // eslint-disable-line react/forbid-prop-types
        url: PropTypes.string,
        name: PropTypes.string.isRequired,
        // Los siguientes son opcionales porque los disfraces subidos desde el disco
        // no tendrán estas propiedades disponibles
