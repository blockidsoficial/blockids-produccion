...
class ComingSoonContent extends React.Component {
    ...
    setShow () {
        // necesario establecer la opacidad en 1, ya que el valor predeterminado es .9 en mostrar
    ...
    getRandomMessage () {
        // elige aleatoriamente un mensaje de `messages` para mostrar en el tooltip.
