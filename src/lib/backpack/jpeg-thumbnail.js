const jpegThumbnail = dataUrl => new Promise((resolve, reject) => {
    ...
    image.onload = () => {
        ...
        if (image.height < 1 || image.width < 1) {
            ...
            // drawImage puede fallar si la altura/ancho de la imagen es menor que 1
            // Usar imagen en blanco; el disfraz es demasiado pequeño para renderizar de todos modos
