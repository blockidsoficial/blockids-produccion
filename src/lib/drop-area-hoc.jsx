    ...
    return function (WrappedComponent) {
        class DropAreaWrapper extends React.Component {
            ...
            componentWillReceiveProps (newProps) {
                // Si `dragging` se vuelve verdadero, registra el rectángulo del área de soltar
                if (newProps.dragInfo.dragging && !this.props.dragInfo.dragging) {
                    this.dropAreaRect = this.ref && this.ref.getBoundingClientRect();
                // Si `dragging` se vuelve falso, llama al controlador de soltar
                ...
                // Si un arrastre está en progreso (currentOffset) y coincide con los tipos de arrastre relevantes,
                // prueba si el arrastre está dentro del rectángulo del área de soltar y establece el estado en consecuencia.
