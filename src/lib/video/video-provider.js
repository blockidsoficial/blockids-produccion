...
class VideoProvider {
    ...
    disableVideo () {
        this.enabled = false;
        // Si hemos comenzado un proceso de configuración, llama a _teardown después de que se complete
    ...
    _teardown () {
        ...
        if (this.enabled === false) {
            ...
            // borrando referencias a video y track, deberemos perder nuestro control sobre la cámara
            this._video = null;
