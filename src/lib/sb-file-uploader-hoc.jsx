...
const SBFileUploaderHOC = function (WrappedComponent) {
    class SBFileUploaderComponent extends React.Component {
        ...
        // paso 1: aquí es donde comienza el proceso de carga
        handleStartSelectingFileUpload () {
            this.createFileObjects(); // ir al paso 2
        }
        // paso 2: crea un FileReader y un elemento <input>, e emite un
        // pseudo-clic en él. Eso abrirá el diálogo del selector de archivos.
        createFileObjects () {
