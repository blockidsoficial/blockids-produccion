...
class AudioSelector extends React.Component {
    ...
    handleTrimEndMouseUp () {
        // Si la selección se hizo rápidamente (tooFast) y es pequeña (tooShort),
        // anula la selección en su lugar. Esto permite hacer clic para deseleccionar incluso si arrastras
        // un poco por accidente. También permite hacer rápidamente una
        // selección, siempre que sea mayor que una longitud mínima.
